...
{	
	public $defaultCaptcha = 'pjCSS_Captcha';
	
	public $defaultLocale = 'pjCSS_LocaleId';
	
	public $defaultFrontStudent = 'pjCSS_Student';
	
	public $defaultLangMenu = 'pjCSS_LangMenu';
	
	public $defaultStore = 'pjCSS_Store';
	
	public $defaultForm = 'pjCSS_Form';
	...
	{		
		if (!isset($_GET['hide']) || (isset($_GET['hide']) && (int) $_GET['hide'] !== 1) &&
			in_array($_GET['action'], array('pjActionClasses', 'pjActionClass', 'pjActionCheckout', 'pjActionPreview')))
		{
	...
	{
		if (isset($_SESSION[$this->defaultFrontStudent]) && count($_SESSION[$this->defaultFrontStudent]) > 0)
		{
			return true;
		}
		return false;
