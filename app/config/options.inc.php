...
if (!defined("PJ_SCRIPT_ID")) define("PJ_SCRIPT_ID", "233");
if (!defined("PJ_SCRIPT_BUILD")) define("PJ_SCRIPT_BUILD", "1.0.0");
if (!defined("PJ_SCRIPT_PREFIX")) define("PJ_SCRIPT_PREFIX", "css_");
