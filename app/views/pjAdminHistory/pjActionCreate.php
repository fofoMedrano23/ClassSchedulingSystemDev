...
if (isset($tpl['status']))
{
	...
	<div class="clear_both">
		<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminHistory&amp;action=pjActionCreate&amp;student_id=<?php echo $_GET['student_id'];?>" method="post" id="frmCreatePayment" class="form pj-form" autocomplete="off" enctype="multipart/form-data">
