...
$message .= '<thead>';
$message .= '<tr>';
$message .= '<th style="padding: 4px;text-align: left;border: 1px solid #000;">'.__('lblDate', true).'</th>';
$message .= '<th style="padding: 4px;text-align: left;border: 1px solid #000;">'.__('lblStartTime', true).'</th>';
$message .= '<th style="padding: 4px;text-align: left;border: 1px solid #000;">'.__('lblEndTime', true).'</th>';
$message .= '<th style="padding: 4px;text-align: left;border: 1px solid #000;">'.__('lblTeacher', true).'</th>';
$message .= '<th style="padding: 4px;text-align: left;border: 1px solid #000;">'.__('lblVenue', true).'</th>';
$message .= '</tr>';
$message .= '</thead>';
$message .= '<tbody>';
...
{
	$message .= '<tr>';
	$message .= '<td style="border: 1px solid #000;padding: 4px;">'.date($tpl['option_arr']['o_date_format'], strtotime($schedule['start_ts'])).'</td>';
	$message .= '<td style="border: 1px solid #000;padding: 4px;">'.date($tpl['option_arr']['o_time_format'], strtotime($schedule['start_ts'])).'</td>';
	$message .= '<td style="border: 1px solid #000;padding: 4px;">'.date($tpl['option_arr']['o_time_format'], strtotime($schedule['end_ts'])).'</td>';
	$message .= '<td style="border: 1px solid #000;padding: 4px;">'.pjSanitize::html($schedule['name']).'</td>';
	$message .= '<td style="border: 1px solid #000;padding: 4px;">'.pjSanitize::html($schedule['venue']).'</td>';
	$message .= '</tr>';
}
$message .= '</tbody>';
$message .= '</table>';
...
?>
<div class="b15"><?php __('infoEmailTeacherTitle');?></div>
...
<form action="" method="post" class="form pj-form">
	...
	<table class="pj-table b15" id="tblTeacher" cellpadding="0" cellspacing="0" style="width: 100%;">
		<thead>
			<tr>
	...
	<input type="button" value="<?php __('btnPlusAdd'); ?>" class="pj-button b15 cpAddRecipient" />
</form>
<?php
?>