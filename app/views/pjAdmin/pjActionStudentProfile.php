...
if (isset($tpl['status']))
{
	...
	<div class="clear_both">
		<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdmin&amp;action=pjActionStudentProfile" method="post" id="frmUpdateProfile" class="form pj-form" enctype="multipart/form-data">
