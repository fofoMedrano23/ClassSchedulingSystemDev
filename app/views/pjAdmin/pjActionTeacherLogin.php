<div class="login-box">
	...
	<h3><?php __('lblTeacherLogin'); ?></h3>
	
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdmin&amp;action=pjActionTeacherLogin" method="post" id="frmLoginAdmin" class="form">
		...
		<p>
			...
			<a class="no-decor l10 block float_left r5 t5" href="<?php echo PJ_INSTALL_URL; ?>index.php?controller=pjAdmin&action=pjActionTeacherForgot"><?php __('lblForgot'); ?></a>
