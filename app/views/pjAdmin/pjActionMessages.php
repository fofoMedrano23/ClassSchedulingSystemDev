...
if (jQuery_1_8_2.datagrid !== undefined) {
	jQuery_1_8_2.extend(jQuery_1_8_2.datagrid.messages, {
		...
		prev_page: "<?php __('gridPrevPage', false); ?>",
		prev: "<?php __('gridPrev', false); ?>",
		next_page: "<?php __('gridNextPage', false); ?>",
		next: "<?php __('gridNext', false); ?>",
...
if (cssApp !== undefined) {
	cssApp = jQuery_1_8_2.extend(cssApp, {
		locale: {
