...
if (isset($tpl['status']))
{
	...
	<div class="clear_both">
		<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminBookings&amp;action=pjActionUpdatePayment" method="post" id="frmUpdatePayment" class="form pj-form" autocomplete="off" enctype="multipart/form-data">
